...
def plotD(data,model,test_col=cols,limits=limits0,legend0=legend00,lab=['a)','b)'],lw=1.0,mw=1.0,ncl=3,xt1=5,yt1=5,xt2=5,yt2=5,ttl="",save=0,ori='v'):
...
def plotU(data,model,test_col=cols,limits=limits0,legend0=legend00,lab=['a)','b)'],lw=1.0,mw=1.0,ncl=3,xt1=5,yt1=5,xt2=5,yt2=5,ttl="",save=0,ori='v'):
    [qmaj,qmin,pmaj,pmin,e2maj,e2min,e1maj,e1min]=limits
    if ori == 'v':
        fig, axes = plt.subplots(2, 1,figsize=(4,6))
    if ori == 'h':
...
def plotISO(data,model,test_col=cols,limits=limits0,legend0=legend00,lab=['a)','b)'],lw=1.0,mw=1.0,ncl=3,xt1=5,yt1=5,xt2=5,yt2=5,ttl=""):
    [qmaj,qmin,pmaj,pmin,e2maj,e2min,e1maj,e1min]=limits
...
def plotOE(data,model,v0s,test_col=cols,limits=[1000,0.1,1.05,0.68],legend0=legend00,lab=['a)','b)'],lw=1.0,mw=1.0,ncl=3,xt1=5,yt1=5,xt2=5,yt2=5,ttl=""):
    ...
    for i in range(len(data)):
        ...
        axes.plot(s1, e, test_col[i],label=legend0[i],linewidth=lw,markersize=mw)
    for j in range(len(model)):
        v0 = v0s[j]
        recl = model[j]
        ep0 = recl[0][1]
...
def plotTCUAN(data,model,test_col=cols,limits=[500,0,400,0,0],legend0=legend00,lab=['a)','b)'],lw=1.0,mw=1.0,ncl=3,xt1=5,yt1=5,xt2=5,yt2=5,ttl=""):
...
def plotTCUEN(data,model,test_col=cols,limits=[500,0,400],legend0=legend00,lab=['a)','b)'],lw=1.0,mw=1.0,ncl=3,xt1=5,yt1=5,xt2=5,yt2=5,ttl=""):
...
def plotISOloglog(data,model,test_col=cols,limits=limits0,legend0=legend00,lw=1.0,ncl=5): #identify m
    [qmaj,qmin,pmaj,pmin,e2maj,e2min,e1maj,e1min]=limits
    ...
    fonts = 12
    fig.legend(ncl=1, loc='center', prop={'size': fonts-2}, bbox_to_anchor=(0.9, 0.5),facecolor='whitesmoke')
    M = 5
...
def plotISOpow(data,model,test_col=cols,limits=limits0,legend0=legend00,lw=1.0,ncl=5):
    [qmaj,qmin,pmaj,pmin,e2maj,e2min,e1maj,e1min]=limits
    fig, axes = plt.subplots(1, 1,figsize=(6,2.5))
    fig.tight_layout()
...
def plotpob(data,model,test_col=cols,limits=limits0,legend0=legend00,lw=1.0,ncol=5): # Plotting for small looping cycles
    [qmaj,qmin,pmaj,pmin,e2maj,e2min,e1maj,e1min]=limits
